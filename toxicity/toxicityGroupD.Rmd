...
Looking at the upper side of the plot, we see correlation values for each feature. MLOGP is the most correlated with LC50, as we can see from the scatterplot down here. Moreover, in this dataseta there aren't any highly correlated features, so it's not recommended to discard any of them.
